...
NEW_CNAMES = {
    "Normal": "Normal",
    "Stage_1_Retinopathy": "Stage_1_Retinopathy",
    "Stage_2_Retinopathy": "Stage_2_Retinopathy",
    "Stage_3_Retinopathy": "Stage_3_Retinopathy",
    "Stage_4_Retinopathy": "Stage_4_Retinopathy",
}

@DATASET_REGISTRY.register()
class IDRID(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_zhou_IDRID.json")
